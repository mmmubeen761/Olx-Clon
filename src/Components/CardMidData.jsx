...
import CardCaraData from './CardCaraData'
                ...
                <div className="row">
                    <div className="col-md-8">
                        <div className="border p-2">
                            <img src={CardCaraData[id].CImages} alt="" width='100%' height='100%' />
                        </div>
                        <div className="border p-2">
                            <div>
                                <h4><b>Details</b></h4>
                    ...
                    <div className="col-md-4">
                        <div className="card w-100 p-2">
                            <div className='row'>
                                <div className='col-md-8'>
                                    <h4 className="card-title mb-0 font-weight-bold"><h1>Rs {CardCaraData[id].Cprice}</h1></h4>
                                </div>
                            ...
                            <div className="card-body">
                                <p className=" text-muted"> {CardCaraData[id].CTitle}</p>
                            </div>
                            <span>
                                <small className='float-left mb-2 ml-3 text-muted '>{CardCaraData[id].CState}</small>
                                <small className='float-right mb-2 mr-3 text-muted'>{CardCaraData[id].CDate}</small>
                            </span>
                        </div>
                        <div className="border py-3 my-3">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-7"><h5> OLX User </h5>member since 2nd Nov 2020</div>
